...
const blogs: MyObj[] = [
  { id: 1, title: "2019.09.21", description: "Google Developer Group ミートアップ in 京都"},
  { id: 2, title: "2019.09.16", description: "久しぶりに自転車に乗った"},
  { id: 3, title: "2019.02.20", description: "Raspbery Pi でスマートホームハブを構築：Hass.io"},
  { id: 4, title: "2019.01.01", description: "新年のご挨拶 と 新天地"},
];
